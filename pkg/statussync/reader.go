...
import (
	...
	"sigs.k8s.io/work-api/pkg/statussync/rules"
)
...
func getValueByJsonPath(name, path string, obj *unstructured.Unstructured) (*workv1alpha1.SyncValue, error) {
